...
export const SEED = {
  ...
  logs: [
    ...
    { id: 'l3', name: 'Grocery run — local market', kg: 2.1, category: 'food', type: 'shopping', at: day(0, 17) },
    { id: 'l4', name: 'Flight YYZ → JFK', kg: 150, category: 'transport', type: 'flight', at: day(1, 14) },
    ...
    { id: 'l10', name: 'Transit commute', kg: -1.4, category: 'transport', type: 'green', at: day(5, 8) },
  ],
  missions: [
    { id: 'm1', text: 'Bike to work', value: '-3.2 kg', done: true },
    { id: 'm2', text: 'Skip meat dinner', value: '-2.1 kg', done: false },
    { id: 'm3', text: 'Public transit once', value: '-1.5 kg', done: false },
  ],
  events: [
  ...
  friends: [
    ...
    { id: 'f2', name: 'Emily', ecoScore: 78, weeklyKg: 29.1, isFocusing: false, x: 68, y: 24, country: 'USA' },
  ...
  racers: [
    ...
    { id: 'r4', name: 'Emily Ross', country: 'USA', weeklyKg: 29.1, ecoScore: 78, circle: true },
    { id: 'r5', name: 'Leo Okonkwo', country: 'Nigeria', weeklyKg: 24.0, ecoScore: 82, circle: false },
    { id: 'r6', name: 'Sydney Hale', country: 'UK', weeklyKg: 41.2, ecoScore: 65, circle: true },
    { id: 'r7', name: 'Priya Shah', country: 'India', weeklyKg: 22.7, ecoScore: 84, circle: false },
  ],
  feed: [
    { id: 'fd1', name: 'An', text: 'logged a bike commute', kg: -3.2, at: day(0, 8) },
    { id: 'fd2', name: 'Alex', text: 'added a short-haul flight. Ouch.', kg: 150, at: day(1, 14) },
  ...
  sparkline: [41, 38, 36, 34, 35, 33, 32.4],
}
